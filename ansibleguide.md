...
Forked from [Jan Warchol](https://github.com/jan-warchol/ansible-styleguide)
...
You should follow the [Best Practices](http://docs.ansible.com/ansible/playbooks_best_practices.html) defined by the Ansible documentation when developing playbooks.  It may also be helpful to install a [linter](https://github.com/willthames/ansible-lint).
