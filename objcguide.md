...
> projects and teams.
> Open-source projects should conform to the requirements in this guide.
>
...
NOTE: The previous convention for Objective-C ivars was a trailing
...
Projects may opt to use an 80 column line length limit for consistency with C++
style guides.
